...
if __name__ == "__main__":
    attack_map_location = "./attack_map.json"
    if not os.path.exists(attack_map_location):
        print("Could not find attack_map.json file. Make sure you run this script "
    ...
    with open(attack_map_location, "w") as attack_map_fh:
        ...
        json.dump({
            "attack_map": att_map,
            "software_map": soft_map,
            "group_map": grp_map,
            "revoke_map": revoke_map,
        }, attack_map_fh, sort_keys=True, indent="    ")
