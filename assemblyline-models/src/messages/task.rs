...
pub fn generate_conf_key(service_tool_version: Option<&str>, task: Option<&Task>, partial: Option<bool>, force_ignore_cache: bool) -> Result<String, serde_json::Error> {
    if let Some(task) = task {
        ...
        let ignore_salt = if task.ignore_cache || force_ignore_cache || partial.unwrap_or_default() {
